...
//  cliffChance = 8;
  trPattern = 1;
   ...
   else if (patternChance == 17) // yukon tundra
   {
      rmSetSeaType("hudson bay");
      rmSetMapType("yukon");
      rmSetMapType("snow");
...
// NATIVE AMERICANS
   ...
   if (nativePattern == 5)
   {
      if (whichNative == 1)
      {
	villageAID = rmCreateGrouping("village A", "/*----------------------------------------------------------------------------------------------------------------*/
...
/*================================================================================================================*/
		...
		// PICKS DEFAULT TERRAIN AND WATER:native iroquois village "+villageType);
      }
      else if (whichNative == 2)
      {
