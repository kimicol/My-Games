...
//	rmSetMapType("grass");
   ...
   // Player constraints
	...
	int avoidNugget=rmCreateTypeDistanceConstraint("nugget avoid nugget", "nugget", 150.0);
  ...
  // Text
   ...
   rmSetAreaSize(centerIslandID, 0.06, 0.4);
...
//  ********************************** Island fingers *******************************
      ...
      rmSetAreaMix(bonusIsland1ID, "amazon_grass");
...
for(i=0; <rmRandInt(28,30))
   {
      ...
      rmSetAreaMix(smallIslandID, "amazon_rain");
...
rmSetStatusText("",0.90);
	...
	rmAddObjectDefItem(nuggetID, "Nugget", 6, 600);
	rmSetObjectDefMinDistance(nuggetID, 0.0);
	rmSetObjectDefMaxDistance(nuggetID, rmXFractionToMeters(1.9));
   ...
   rmAddObjectDefItem(randomTreeID, "treeamazon", 3, 0.0);
...
*/
   ...
   rmAddObjectDefItem(fishID, "FishSalmon", 10, 9.0);
