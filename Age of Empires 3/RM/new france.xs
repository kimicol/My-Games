...
// *** RMS Generator File *** 25/8/2006 *** 23:54:53 ***
...
rmTerrainInitialize("rockies\ground2_roc",6);
rmSetMapType("greatPlains");
rmSetMapType("grass");
rmSetMapType("default");
rmSetMapType("water");
rmSetMapType("land");
rmSetLightingSet("Berlin");
rmSetSeaLevel(6);
...
{
int subCiv00=rmGetCivID("Iroquois");
rmSetSubCiv(0, "Iroquois");
int subCiv01=rmGetCivID("Iroquois");
rmSetSubCiv(1, "Iroquois");
int subCiv02=rmGetCivID("Iroquois");
...
rmSetAreaTerrainType(AREAL1,"rockies\ground1_roc");
rmAddAreaTerrainLayer(AREAL1, "rockies\groundforest_roc", 10, 15);
...
rmSetAreaTerrainType(AREAL2,"rockies\groundforest_roc");
rmAddAreaTerrainLayer(AREAL1, "rockies\groundforest_roc", 8, 15);
...
rmSetAreaTerrainType(AREAL3,"rockies\groundforest_roc");
rmAddAreaTerrainLayer(AREAL1, "rockies\ground2_roc", 5, 15);
...
rmAddObjectDefItem(playerTreeID, "TreeRockies", 5, 0.0);
...
rmAddObjectDefItem(ExtraUnit1ID, "Blockhouse",1, 6.0);
...
int VillageID1 = rmCreateGrouping("Iroquois village1", "native Iroquois village 4");
...
int VillageID2 = rmCreateGrouping("Iroquois village2", "native Iroquois village 1");
...
int VillageID3 = rmCreateGrouping("Iroquois village3", "native Iroquois village 2");
...
int WildAID=rmCreateObjectDef("cow-1");
rmAddObjectDefItem(WildAID, "cow", 25, 20);
...
int WildBID=rmCreateObjectDef("cow-2");
rmAddObjectDefItem(WildBID, "cow", 25, 20);
...
int WildCID=rmCreateObjectDef("cow-3");
rmAddObjectDefItem(WildCID, "cow", 25, 20);
...
int WildDID=rmCreateObjectDef("cow-4");
rmAddObjectDefItem(WildDID, "cow", 25, 20);
...
rmSetAreaForestType(forest, "Rockies Forest");
