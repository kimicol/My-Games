...
// *** RMS Generator File *** 24/8/2006 *** 00:13:15 ***
...
void main(void)
{
rmSetMapSize((2*sqrt(cNumberNonGaiaPlayers*31250)), (2*sqrt(cNumberNonGaiaPlayers*31250)));
rmSetMapElevationParameters(cElevTurbulence, .025, 2.0, 0.01, 10.0);
rmSetMapElevationHeightBlend(0.1);
rmTerrainInitialize("amazon\ground1_ama",2);
...
int subCiv02=rmGetCivID("Caribs");
rmSetSubCiv(2, "Caribs");
int subCiv03=rmGetCivID("Caribs");
...
rmSetAreaTerrainType(AREAL1,"great_plains\ground4_gp");
rmAddAreaTerrainLayer(AREAL1, "yucatan\ground1_yuc", 10, 15);
...
rmSetAreaTerrainType(AREAL2,"yucatan\ground1_yuc");
rmAddAreaTerrainLayer(AREAL1, "great_plains\ground4_gp", 8, 15);
...
rmSetAreaTerrainType(AREAL3,"great_plains\ground4_gp");
rmAddAreaTerrainLayer(AREAL1, "amazon\ground1_ama", 5, 15);
...
TradeRoutePoint1 = rmFindClosestPoint(0.10, 0.85,1);
rmAddTradeRouteWaypoint(tradeRoute1, rmXMetersToFraction(xsVectorGetX(TradeRoutePoint1)), rmZMetersToFraction(xsVectorGetZ(TradeRoutePoint1)));
rmAddRandomTradeRouteWaypoints(tradeRoute1, 0.5, 0.8,15,15);
rmAddRandomTradeRouteWaypoints(tradeRoute1, 0.5, 0.15,15,15);
TradeRoutePoint1 = rmFindClosestPoint(0.85, 0.10, 1);
rmAddRandomTradeRouteWaypoints(tradeRoute1, rmXMetersToFraction(xsVectorGetX(TradeRoutePoint1)), rmZMetersToFraction(xsVectorGetZ(TradeRoutePoint1)),15,15);
rmBuildTradeRoute(tradeRoute1, "dirt");
...
rmAddObjectDefItem(playerTreeID, "TreeNewEngland", 5, 0.0);
...
int wild1ID=rmCreateObjectDef("deers");
rmAddObjectDefItem(wild1ID, "deer", 8, 8.0);
...
int VillageID3 = rmCreateGrouping("Caribs village3", "native Caribs village 2");
...
int VillageID4 = rmCreateGrouping("Caribs village4", "native Caribs village 3");
...
int GoldID = -1;
int GoldCount = cNumberNonGaiaPlayers;
for(i=0; < GoldCount)
{
...
int SchatzID = -1;
int SchatzCount = cNumberNonGaiaPlayers;
for(i=0; < SchatzCount)
{
...
int WildAID=rmCreateObjectDef("muskOx-1");
rmAddObjectDefItem(WildAID, "muskOx", 25, 20);
